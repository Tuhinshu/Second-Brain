...
if not NOTION_TASKS_DB_ID:
    raise ValueError(
        "CRITICAL: NOTION_TASKS_DB_ID is not set as an environment variable or deployment secret."
    )


def _parse_max_active_tasks(raw_val: str, default: int = 50, min_val: int = 1, max_val: int = 500) -> int:
